...
from main_app.validators import RangeValuesValidator
...
class VideoGame(models.Model):
    ...
    release_year = models.PositiveIntegerField(
        validators=[
            RangeValuesValidator(1990, 2023, message="The release year must be between 1990 and 2023"),
        ]
    )
